...
button{
    ...
    <body>
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="POST">
            <div class='container'>
            <label for ="type">Enter the type of fertilizer you want to buy</label>
...
if(isset($_POST['Submit'])){
   ...
   $usernamequery = " select * from fertilizer where type= '$type'";
...
<button type="submit"><a href="fcusttransaction.php">BUY</a></button>
</div>
        </body>
    </body>
</html>