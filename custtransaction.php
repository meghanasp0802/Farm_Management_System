...
if(isset($_POST['Submit'])){
   ...
   if($query){
    if($query1){
        $insertquery = "insert into transaction(name, cropid, tid)values('$name','$id','$tid')";
...
?>
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="POST">
            ...
            <label for="id"><b>Crop ID</b></label>
            <input type="text" placeholder="Enter crop id" name="id" id="id" required/>
